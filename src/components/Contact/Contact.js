        ...
        <Row>
          ...
          <Col md={4} className="text-white">
            ...
            <h6 className="lead border-bottom mb-4 pb-3">
              Name: <span className="font-weight-bold">  Fazle Chisty Himel</span>
            </h6>
            <h6 className="lead border-bottom mb-4 pb-3">
              Location: <span className="font-weight-bold"> Mohipal, Feni</span>
            </h6>
            <h6 className="lead border-bottom mb-4 pb-3">
            ...
            <h6 className="lead border-bottom mb-4 pb-3">
              Email:{" "}
              <span className="font-weight-bold"> fazle.chisty@gmail.com</span>
            </h6>
          </Col>
        </Row>
      </Container>
